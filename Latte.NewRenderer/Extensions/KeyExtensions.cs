...
{
	internal static ImGuiKey ToImGui( this Key key )
	{
		return key switch
		{
			Key.A => ImGuiKey.A,
			...
			Key.World1 => ImGuiKey.AppBack,
			Key.World2 => ImGuiKey.AppForward,
			Key.F25 => ImGuiKey.None,
			Key.Unknown => throw new ArgumentOutOfRangeException( nameof( key ) ),
