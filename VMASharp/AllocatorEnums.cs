...
namespace VMASharp
{
	...
	public enum MemoryUsage
	{
		...
		/// </summary>
		/// <remarks>
		///     Usage: Resources written frequently by host (dynamic), read by device. E.g. textures, vertex buffers, uniform
		///     buffers updated every frame or every draw call.
		/// </remarks>
		CPU_To_GPU,
		...
		///     Exists mostly on mobile platforms. Using it on desktop PC or other GPUs with no such memory type present will fail
		///     the allocation.
